...
resource "aws_iam_policy" "iam_policy_for_cloud_resume" {
  ...
  path        = "/"
  description = "AWS IAM Policy for dynamodb"
...
data "archive_file" "lambda" {
  ...
  output_path = "lambda_function_packed.zip"
}   
resource "aws_lambda_function_url" "furl" {
  function_name      = aws_lambda_function.cloud_lambda.function_name
